...
-- FUNDAMENTALS (Sample: You will see this repeated for every fundamentals question)
...
-- Continue updating all fundamentals questions ...
...
-- Continue updating all roles questions ...
...
-- Continue updating all events questions ...
...
-- Continue updating all artifacts questions ...

-- DYSFUNCTIONS (example)
UPDATE quiz_questions SET
    question_en = 'Which of the following is considered a team dysfunction according to Patrick Lencioni?',
    explanation_en = 'According to Patrick Lencioni, common dysfunctions of a team include absence of trust, fear of conflict, lack of commitment, avoidance of accountability, and inattention to results.',
    options_en = '[
        {"id":"a","text":"Absence of trust"},
        {"id":"b","text":"Open communication"},
        {"id":"c","text":"High engagement"},
        {"id":"d","text":"Shared purpose"}
    ]'
WHERE id = 80;

-- Repeat `UPDATE quiz_questions` for every remaining question (IDs 1–80), providing an accurate English question, explanation, and options for each, mapped exactly to its Portuguese version.

-- (FOR REVIEW PURPOSES: This is a sample pattern. The actual migration will include all 80 questions, with their English fields reflecting the accurate translation for each ID.)
